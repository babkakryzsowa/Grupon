...
use Grupon\UserBundle\Entity\Page;
use Grupon\UserBundle\Form\PageFilterType;
...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('GruponUserBundle:Page:index.html.twig', array(
            'entities' => $entities,
            'pagerHtml' => $pagerHtml,
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('GruponUserBundle:Page')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GruponUserBundle:Page')->find($id);

        if (!$entity) {
            throw $this->createNotFoundException('Unable to find Page entity.');
        }

        return $this->render('GruponUserBundle:Page:show.html.twig', array(
            'entity'      => $entity,
        ));
    }
