...
use Grupon\AdminBundle\Entity\Page;
use Grupon\AdminBundle\Form\PageFilterType;
...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('GruponAdminBundle:Page:index.html.twig', array(
            'entities' => $entities,
            'pagerHtml' => $pagerHtml,
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('GruponAdminBundle:Page')->createQueryBuilder('e');
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GruponAdminBundle:Page')->find($id);

        if (!$entity) {
            throw $this->createNotFoundException('Unable to find Page entity.');
        }

        return $this->render('GruponAdminBundle:Page:show.html.twig', array(
            'entity'      => $entity,
        ));
    }
